...
1. Create VM: General
   ![1.1](./images/set-proxmox/1.1.png)
2. Create VM: OS
   ![1.2](./images/set-proxmox/1.2.png)
3. Create VM: System
   ![1.3](./images/set-proxmox/1.3.png)
4. Create VM: Disks
   ![1.4](./images/set-proxmox/1.4.png)
5. Create VM: CPU
   ![1.5](./images/set-proxmox/1.5.png)
6. Create VM: Memory
   ![1.6](./images/set-proxmox/1.6.png)
7. Create VM: Network
   ![1.7](./images/set-proxmox/1.7.png)
8. Create VM: Confirm
   ![1.8](./images/set-proxmox/1.8.png)
...
Change boot options to disk and then booting for the first time to initialize the node, activate etcd by doing the following:
![change boot](./images/boot-masih-ke-iso(1.4).png)
...
![bootstrap](./images/after-set-bootstrap-first-node(1.5).png)
...
![Network manifest](./images/set-network&hostname-in-manifest-worker(1.6.1).png)
![Hostname manifest](./images/set-network&hostname-in-manifest-worker(1.6.2).png)
...
Console talos worker nodes
![Worker Nodes](./images/consol-talos-proxmox-worker(1.7).png)